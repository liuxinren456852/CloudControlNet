...
int main(/*int argc, char** argv*/)
{
	...
	bool registration_use_reciprocal_corres = atoi(argv[13]);
	bool registration_use_use_trimmed_rejector = atoi(argv[14]);
	float registration_perturbate_dis = atof(argv[15]);
