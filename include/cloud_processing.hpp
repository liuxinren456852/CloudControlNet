...
{
  public:
	bool GroundFilter_PMF(const typename pcl::PointCloud<PointT>::Ptr &cloud, typename pcl::PointCloud<PointT>::Ptr &gcloud, typename pcl::PointCloud<PointT>::Ptr &ngcloud, int max_window_size, float slope, float initial_distance, float max_distance); // PMF �������˲�;
	{
	...
	bool planesegRansac(const typename pcl::PointCloud<PointT>::Ptr &cloud, float threshold, typename pcl::PointCloud<PointT>::Ptr &planecloud); //Ransac ƽ�����;
	{
	...
	bool SORFilter(const typename pcl::PointCloud<PointT>::Ptr &incloud, int MeanK, double std, typename pcl::PointCloud<PointT>::Ptr &outcloud); //SOR ��Statisics Outliers Remover);
	{
		// Create the filtering object
